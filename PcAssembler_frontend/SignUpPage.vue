<template>
    <div class="signup-container">
      ...
      <p class="already-account">Already have an account? <a href="/login" class="login-link">Login here</a></p>
    </div>
  </template>
  ...
  .submit-button {
    ...
    cursor: pointer;
    font-size: 16px;
    transition: background-color 0.3s, transform 0.3s; /* Button hover and transition effect */
